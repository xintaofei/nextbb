...
import { BadgeStatsCard } from "@/components/admin/badge-stats-card"
import { BadgeCard } from "@/components/admin/badge-card"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="1">
                    {t("filter.levelOptions.1")}
                  </SelectItem>
                  <SelectItem value="2">
                    {t("filter.levelOptions.2")}
                  </SelectItem>
                  <SelectItem value="3">
                    {t("filter.levelOptions.3")}
                  </SelectItem>
                  <SelectItem value="4">
                    {t("filter.levelOptions.4")}
                  </SelectItem>
                  <SelectItem value="5">
                    {t("filter.levelOptions.5")}
                  </SelectItem>
                </SelectContent>
              </Select>
