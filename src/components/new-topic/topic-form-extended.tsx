...
import { createTopicFormSchemaWithCredits } from "@/lib/topic-validation"
import {
  MessageSquare,
  HelpCircle,
  Trophy,
...
interface TopicFormExtendedProps {
  onSubmit: (data: unknown) => void
  isSubmitting?: boolean
  onCancel?: () => void
}

export function TopicFormExtended({
  onSubmit,
  isSubmitting = false,
  onCancel,
}: TopicFormExtendedProps) {
  ...
  const handleTypeChange = (type: string) => {
    ...
    const baseValues = {
      ...
      isPinned: form.getValues("isPinned"),
      isCommunity: form.getValues("isCommunity"),
    }
